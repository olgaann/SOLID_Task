...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int productsCount = products.size(); //определяем размер ассортимента, чтобы впоследствии отталкиваться от него при создании экземпляра Purchase
        ...
        Purchase purchase = new Purchase(productsCount); //cоздаем экземпляр Purchase в соответствии с размером ассортимента
        while (true) {
        ...
        purchase.finalPrint(products); //метод вывода итоговой покупки создан в классе Purchase (принцип единственной ответственности)
    }
}
